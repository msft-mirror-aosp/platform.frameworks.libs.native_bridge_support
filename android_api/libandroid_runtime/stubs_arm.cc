...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN7android10getFieldSpINS_10AudioTrackEEENS_2spIT_EEP7_JNIEnvP8_jobjectP9_jfieldID);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN7android23checkAndClearBlobFooterEPNS_10BufferItemERNS_2spINS_5FenceEEE);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_content_res_resources_manager_cache_leak_cleanup);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(com_android_graphics_libgui_flags_allocate_buffer_priority_inheritance);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(com_android_graphics_libgui_flags_apply_picture_profiles);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(com_android_graphics_libgui_flags_bq_consumer_attach_callback);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(com_android_graphics_libgui_flags_bq_extendedallocate);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(com_android_graphics_libgui_flags_bq_gl_fence_cleanup);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(com_android_graphics_libgui_flags_bq_producer_backpressure_control);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(com_android_graphics_libgui_flags_composition_shaders);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(com_android_graphics_libgui_flags_consumer_present_modes);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(com_android_graphics_libgui_flags_debug_gpu_present_times);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(com_android_graphics_libgui_flags_default_scaling_mode_freeze);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(com_android_graphics_libgui_flags_frametimestamps_previousrelease);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(com_android_graphics_libgui_flags_out_of_process_rendering);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(com_android_graphics_libgui_flags_remove_controlled_by_app);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(com_android_graphics_libgui_flags_surface_texture_updateteximage_stop_early);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(com_android_graphics_libgui_flags_unapplied_transaction_cleanup);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(com_android_graphics_libgui_flags_wb_aaos);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(com_android_graphics_libgui_flags_wb_biometrics);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(com_android_graphics_libgui_flags_wb_libcameraservice);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(com_android_graphics_libgui_flags_wb_media_migration);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(com_android_graphics_libgui_flags_wb_ring_buffer);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(com_android_graphics_libgui_flags_wb_surfacetexture);
...
static void __attribute__((constructor(0))) init_stub_library() {
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN7android10getFieldSpINS_10AudioTrackEEENS_2spIT_EEP7_JNIEnvP8_jobjectP9_jfieldID);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN7android23checkAndClearBlobFooterEPNS_10BufferItemERNS_2spINS_5FenceEEE);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_content_res_resources_manager_cache_leak_cleanup);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", com_android_graphics_libgui_flags_allocate_buffer_priority_inheritance);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", com_android_graphics_libgui_flags_apply_picture_profiles);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", com_android_graphics_libgui_flags_bq_consumer_attach_callback);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", com_android_graphics_libgui_flags_bq_extendedallocate);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", com_android_graphics_libgui_flags_bq_gl_fence_cleanup);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", com_android_graphics_libgui_flags_bq_producer_backpressure_control);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", com_android_graphics_libgui_flags_composition_shaders);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", com_android_graphics_libgui_flags_consumer_present_modes);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", com_android_graphics_libgui_flags_debug_gpu_present_times);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", com_android_graphics_libgui_flags_default_scaling_mode_freeze);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", com_android_graphics_libgui_flags_frametimestamps_previousrelease);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", com_android_graphics_libgui_flags_out_of_process_rendering);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", com_android_graphics_libgui_flags_remove_controlled_by_app);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", com_android_graphics_libgui_flags_surface_texture_updateteximage_stop_early);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", com_android_graphics_libgui_flags_unapplied_transaction_cleanup);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", com_android_graphics_libgui_flags_wb_aaos);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", com_android_graphics_libgui_flags_wb_biometrics);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", com_android_graphics_libgui_flags_wb_libcameraservice);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", com_android_graphics_libgui_flags_wb_media_migration);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", com_android_graphics_libgui_flags_wb_ring_buffer);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", com_android_graphics_libgui_flags_wb_surfacetexture);
