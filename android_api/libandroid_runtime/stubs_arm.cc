...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN13RecipientListIN7android7IBinder14DeathRecipientEE4findEP8_jobject);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN13RecipientListIN7android7IBinder25FrozenStateChangeCallbackEE4findEP8_jobject);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto10NamedTrack12delete_trackEPS0_);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto10NamedTrackC2EyyRKNSt3__112basic_stringIcNS1_11char_traitsIcEENS1_9allocatorIcEEEE);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto10traceBeginEyPKc);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto11trace_eventEiPK18PerfettoTeCategoryPKcPNS_5ExtraE);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto12isTagEnabledEy);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto12traceCounterEyPKcx);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto12traceInstantEyPKc);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto13traceAsyncEndEyPKci);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto14traceCounter32EyPKci);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto15RegisteredTrack12delete_trackEPS0_);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto15RegisteredTrack14register_trackEv);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto15RegisteredTrack16unregister_trackEv);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto15RegisteredTrackC2EyyRKNSt3__112basic_stringIcNS1_11char_traitsIcEENS1_9allocatorIcEEEEb);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto15RegisteredTrackD2Ev);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto15traceAsyncBeginEyPKci);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto16ProtoFieldNested12delete_fieldEPS0_);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto16ProtoFieldNested6set_idEj);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto16ProtoFieldNested9add_fieldEP22PerfettoTeHlProtoField);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto16ProtoFieldNestedC2Ev);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto16activate_triggerEPKcj);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto16traceFormatBeginEyPKcz);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto18traceFormatInstantEyPKcz);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto20registerWithPerfettoEb);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto20traceInstantForTrackEyPKcS1_);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto21get_thread_track_uuidEi);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto21traceAsyncEndForTrackEyPKci);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto22get_process_track_uuidEv);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto23traceAsyncBeginForTrackEyPKcS1_i);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto4Flow11delete_flowEPS0_);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto4Flow16set_process_flowEy);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto4Flow28set_process_terminating_flowEy);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto4FlowC2Ev);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto5Extra10push_extraEP17PerfettoTeHlExtra);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto5Extra12clear_extrasEv);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto5Extra12delete_extraEPS0_);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto5Extra9pop_extraEv);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto5ExtraC2Ev);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto5Proto12clear_fieldsEv);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto5Proto12delete_protoEPS0_);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto5Proto9add_fieldEP22PerfettoTeHlProtoField);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto5ProtoC2Ev);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto7Session12ReadBlockingEv);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto7Session12StopBlockingEv);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto7Session13FlushBlockingEj);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto7Session14delete_sessionEPS0_);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto7SessionC2EbPvj);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto7SessionD2Ev);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto8Category15delete_categoryEPS0_);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto8Category17register_categoryEv);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto8Category19is_category_enabledEv);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto8Category19unregister_categoryEv);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto8CategoryC2ERKNSt3__112basic_stringIcNS1_11char_traitsIcEENS1_9allocatorIcEEEES9_S9_);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto8CategoryD2Ev);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto8internal16perfettoTraceEndERK18PerfettoTeCategory);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto8internal17updatePreferFlagsEv);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto8internal18perfettoTraceBeginERK18PerfettoTeCategoryPKc);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto8internal18shouldPreferAtraceEP18PerfettoTeCategoryy);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto8internal18toPerfettoCategoryEy);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto8internal20perfettoTraceCounterERK18PerfettoTeCategoryPKcx);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto8internal20perfettoTraceInstantERK18PerfettoTeCategoryPKc);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto8internal20registerWithPerfettoEb);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto8internal21perfettoTraceAsyncEndERK18PerfettoTeCategoryPKcy);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto8internal23perfettoTraceAsyncBeginERK18PerfettoTeCategoryPKcy);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto8internal25isPerfettoCategoryEnabledEP18PerfettoTeCategory);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto8internal28perfettoTraceInstantForTrackERK18PerfettoTeCategoryPKcS5_);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto8internal29perfettoTraceAsyncEndForTrackERK18PerfettoTeCategoryPKcy);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto8internal31perfettoTraceAsyncBeginForTrackERK18PerfettoTeCategoryPKcS5_y);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN16tracing_perfetto8traceEndEy);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN7android21getFrameRateOverridesENSt3__16vectorINS_20DisplayEventReceiver5Event17FrameRateOverrideENS0_9allocatorIS4_EEEEP7_JNIEnv);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN7android24getSupportedRefreshRatesENSt3__16vectorINS_20DisplayEventReceiver5Event20SupportedRefreshRateENS0_9allocatorIS4_EEEEP7_JNIEnv);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN7android25InputFrameMetricsObserver6notifyERKNSt3__15arrayIxLj24EEE);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN7android25SurfaceTexture_getSurfaceEP7_JNIEnvP8_jobject);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN7android26NativeDisplayEventReceiver41dispatchModeChangedWithFrameRateOverridesExNS_17PhysicalDisplayIdEixxxNSt3__16vectorINS_20DisplayEventReceiver5Event17FrameRateOverrideENS2_9allocatorIS6_EEEENS3_INS5_20SupportedRefreshRateENS7_ISA_EEEE);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN7android2spINS_26CornerRadiiCallbackWrapperEED2Ev);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN7android2spINS_30TransactionHangCallbackWrapperEED2Ev);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN7android2spINS_35WaitForBufferReleaseCallbackWrapperEED2Ev);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN7android33android_os_PerfettoTrace_registerEb);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN7android33register_android_os_PerfettoTraceEP7_JNIEnv);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN7android43register_android_os_PerfettoTrackEventExtraEP7_JNIEnv);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN7android8internal8ToStringINS_5media5audio6common15AudioDeviceTypeEEENSt3__112basic_stringIcNS6_11char_traitsIcEENS6_9allocatorIcEEEERKT_);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN7android8internal8ToStringINS_5media5audio6common15AudioFormatTypeEEENSt3__112basic_stringIcNS6_11char_traitsIcEENS6_9allocatorIcEEEERKT_);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZNK16tracing_perfetto10NamedTrack3getEv);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZNK16tracing_perfetto15RegisteredTrack3getEv);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZNK16tracing_perfetto16ProtoFieldNested3getEv);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZNK16tracing_perfetto4Flow3getEv);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZNK16tracing_perfetto5Extra3getEv);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZNK16tracing_perfetto5Proto3getEv);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZNK16tracing_perfetto8Category3getEv);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_content_res_overlay_constraint_aware_asset_path_changes);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_adpf_25q2_metrics);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_adpf_audio_performance);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_adpf_cap_max_batch_size);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_adpf_gpu_report_actual_work_duration);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_adpf_measure_during_input_event_boost);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_adpf_platform_power_efficiency);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_adpf_prefer_power_efficiency);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_adpf_use_load_hints);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_allow_consentless_bugreport_delegated_consent);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_allow_private_profile);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_allow_thermal_hal_skin_forecast);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_allow_thermal_headroom_thresholds);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_allow_thermal_thresholds_callback);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_android_os_build_vanilla_ice_cream);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_api_for_backported_fixes);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_async_trace_for_track);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_battery_charging_info_api);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_battery_manufacturer_diagnostics_api);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_battery_part_status_api);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_battery_saver_supported_check_api);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_battery_service_support_current_adb_command);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_binder_frozen_state_change_callback);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_binder_netlink_enabled);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_binder_proxy_use_executor_map);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_bluetooth_bugreport_mode);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_bugreport_multi_display_screenshot_enabled);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_count_class_instances_api);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_cpu_gpu_headrooms);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_disable_madvise_artfile_default);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_disallow_add_guest);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_enable_angle_deny_list);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_enable_angle_for_games);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_enable_has_binders);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_get_private_space_settings);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_initiate_bugreport_as_non_admin);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_ipc_data_cache_module_adservices);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_ipc_data_cache_testmode_apis);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_low_light_dream_behavior);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_mainline_vcn_platform_api);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_material_colors_10_2024);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_material_colors_2025_03);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_material_default_user_icon);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_material_motion_tokens);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_material_shape_tokens);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_message_queue_testability);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_native_app_zygote);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_native_framework_prototype);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_native_looper_skip_epoll_wait_for_zero_timeout);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_network_time_uses_shared_memory);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_ordered_broadcast_multiple_permissions);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_parcel_marshall_bytebuffer);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_parcel_string_cache_enabled);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_perfetto_sdk_tracing_disable_app_registration_sharding);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_perfetto_sdk_tracing_enable_app_registration);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_perfetto_sdk_tracing_v3);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_remove_app_profiler_pss_collection);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_security_state_service);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_state_of_health_public);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_storage_lifetime_api);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_strict_mode_restricted_network);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_strongbox_properties_api);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_supplemental_security_patches);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_telemetry_apis_framework_initialization);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_update_engine_api);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_use_concurrent_message_queue_in_apps);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_os_use_query_angle_choice);
...
static void __attribute__((constructor(0))) init_stub_library() {
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN13RecipientListIN7android7IBinder14DeathRecipientEE4findEP8_jobject);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN13RecipientListIN7android7IBinder25FrozenStateChangeCallbackEE4findEP8_jobject);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto10NamedTrack12delete_trackEPS0_);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto10NamedTrackC2EyyRKNSt3__112basic_stringIcNS1_11char_traitsIcEENS1_9allocatorIcEEEE);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto10traceBeginEyPKc);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto11trace_eventEiPK18PerfettoTeCategoryPKcPNS_5ExtraE);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto12isTagEnabledEy);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto12traceCounterEyPKcx);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto12traceInstantEyPKc);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto13traceAsyncEndEyPKci);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto14traceCounter32EyPKci);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto15RegisteredTrack12delete_trackEPS0_);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto15RegisteredTrack14register_trackEv);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto15RegisteredTrack16unregister_trackEv);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto15RegisteredTrackC2EyyRKNSt3__112basic_stringIcNS1_11char_traitsIcEENS1_9allocatorIcEEEEb);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto15RegisteredTrackD2Ev);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto15traceAsyncBeginEyPKci);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto16ProtoFieldNested12delete_fieldEPS0_);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto16ProtoFieldNested6set_idEj);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto16ProtoFieldNested9add_fieldEP22PerfettoTeHlProtoField);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto16ProtoFieldNestedC2Ev);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto16activate_triggerEPKcj);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto16traceFormatBeginEyPKcz);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto18traceFormatInstantEyPKcz);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto20registerWithPerfettoEb);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto20traceInstantForTrackEyPKcS1_);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto21get_thread_track_uuidEi);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto21traceAsyncEndForTrackEyPKci);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto22get_process_track_uuidEv);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto23traceAsyncBeginForTrackEyPKcS1_i);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto4Flow11delete_flowEPS0_);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto4Flow16set_process_flowEy);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto4Flow28set_process_terminating_flowEy);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto4FlowC2Ev);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto5Extra10push_extraEP17PerfettoTeHlExtra);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto5Extra12clear_extrasEv);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto5Extra12delete_extraEPS0_);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto5Extra9pop_extraEv);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto5ExtraC2Ev);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto5Proto12clear_fieldsEv);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto5Proto12delete_protoEPS0_);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto5Proto9add_fieldEP22PerfettoTeHlProtoField);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto5ProtoC2Ev);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto7Session12ReadBlockingEv);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto7Session12StopBlockingEv);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto7Session13FlushBlockingEj);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto7Session14delete_sessionEPS0_);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto7SessionC2EbPvj);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto7SessionD2Ev);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto8Category15delete_categoryEPS0_);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto8Category17register_categoryEv);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto8Category19is_category_enabledEv);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto8Category19unregister_categoryEv);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto8CategoryC2ERKNSt3__112basic_stringIcNS1_11char_traitsIcEENS1_9allocatorIcEEEES9_S9_);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto8CategoryD2Ev);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto8internal16perfettoTraceEndERK18PerfettoTeCategory);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto8internal17updatePreferFlagsEv);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto8internal18perfettoTraceBeginERK18PerfettoTeCategoryPKc);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto8internal18shouldPreferAtraceEP18PerfettoTeCategoryy);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto8internal18toPerfettoCategoryEy);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto8internal20perfettoTraceCounterERK18PerfettoTeCategoryPKcx);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto8internal20perfettoTraceInstantERK18PerfettoTeCategoryPKc);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto8internal20registerWithPerfettoEb);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto8internal21perfettoTraceAsyncEndERK18PerfettoTeCategoryPKcy);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto8internal23perfettoTraceAsyncBeginERK18PerfettoTeCategoryPKcy);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto8internal25isPerfettoCategoryEnabledEP18PerfettoTeCategory);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto8internal28perfettoTraceInstantForTrackERK18PerfettoTeCategoryPKcS5_);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto8internal29perfettoTraceAsyncEndForTrackERK18PerfettoTeCategoryPKcy);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto8internal31perfettoTraceAsyncBeginForTrackERK18PerfettoTeCategoryPKcS5_y);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN16tracing_perfetto8traceEndEy);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN7android21getFrameRateOverridesENSt3__16vectorINS_20DisplayEventReceiver5Event17FrameRateOverrideENS0_9allocatorIS4_EEEEP7_JNIEnv);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN7android24getSupportedRefreshRatesENSt3__16vectorINS_20DisplayEventReceiver5Event20SupportedRefreshRateENS0_9allocatorIS4_EEEEP7_JNIEnv);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN7android25InputFrameMetricsObserver6notifyERKNSt3__15arrayIxLj24EEE);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN7android25SurfaceTexture_getSurfaceEP7_JNIEnvP8_jobject);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN7android26NativeDisplayEventReceiver41dispatchModeChangedWithFrameRateOverridesExNS_17PhysicalDisplayIdEixxxNSt3__16vectorINS_20DisplayEventReceiver5Event17FrameRateOverrideENS2_9allocatorIS6_EEEENS3_INS5_20SupportedRefreshRateENS7_ISA_EEEE);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN7android2spINS_26CornerRadiiCallbackWrapperEED2Ev);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN7android2spINS_30TransactionHangCallbackWrapperEED2Ev);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN7android2spINS_35WaitForBufferReleaseCallbackWrapperEED2Ev);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN7android33android_os_PerfettoTrace_registerEb);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN7android33register_android_os_PerfettoTraceEP7_JNIEnv);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN7android43register_android_os_PerfettoTrackEventExtraEP7_JNIEnv);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN7android8internal8ToStringINS_5media5audio6common15AudioDeviceTypeEEENSt3__112basic_stringIcNS6_11char_traitsIcEENS6_9allocatorIcEEEERKT_);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN7android8internal8ToStringINS_5media5audio6common15AudioFormatTypeEEENSt3__112basic_stringIcNS6_11char_traitsIcEENS6_9allocatorIcEEEERKT_);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZNK16tracing_perfetto10NamedTrack3getEv);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZNK16tracing_perfetto15RegisteredTrack3getEv);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZNK16tracing_perfetto16ProtoFieldNested3getEv);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZNK16tracing_perfetto4Flow3getEv);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZNK16tracing_perfetto5Extra3getEv);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZNK16tracing_perfetto5Proto3getEv);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZNK16tracing_perfetto8Category3getEv);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_content_res_overlay_constraint_aware_asset_path_changes);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_adpf_25q2_metrics);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_adpf_audio_performance);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_adpf_cap_max_batch_size);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_adpf_gpu_report_actual_work_duration);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_adpf_measure_during_input_event_boost);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_adpf_platform_power_efficiency);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_adpf_prefer_power_efficiency);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_adpf_use_load_hints);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_allow_consentless_bugreport_delegated_consent);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_allow_private_profile);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_allow_thermal_hal_skin_forecast);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_allow_thermal_headroom_thresholds);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_allow_thermal_thresholds_callback);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_android_os_build_vanilla_ice_cream);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_api_for_backported_fixes);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_async_trace_for_track);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_battery_charging_info_api);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_battery_manufacturer_diagnostics_api);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_battery_part_status_api);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_battery_saver_supported_check_api);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_battery_service_support_current_adb_command);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_binder_frozen_state_change_callback);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_binder_netlink_enabled);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_binder_proxy_use_executor_map);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_bluetooth_bugreport_mode);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_bugreport_multi_display_screenshot_enabled);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_count_class_instances_api);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_cpu_gpu_headrooms);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_disable_madvise_artfile_default);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_disallow_add_guest);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_enable_angle_deny_list);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_enable_angle_for_games);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_enable_has_binders);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_get_private_space_settings);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_initiate_bugreport_as_non_admin);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_ipc_data_cache_module_adservices);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_ipc_data_cache_testmode_apis);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_low_light_dream_behavior);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_mainline_vcn_platform_api);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_material_colors_10_2024);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_material_colors_2025_03);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_material_default_user_icon);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_material_motion_tokens);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_material_shape_tokens);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_message_queue_testability);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_native_app_zygote);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_native_framework_prototype);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_native_looper_skip_epoll_wait_for_zero_timeout);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_network_time_uses_shared_memory);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_ordered_broadcast_multiple_permissions);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_parcel_marshall_bytebuffer);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_parcel_string_cache_enabled);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_perfetto_sdk_tracing_disable_app_registration_sharding);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_perfetto_sdk_tracing_enable_app_registration);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_perfetto_sdk_tracing_v3);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_remove_app_profiler_pss_collection);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_security_state_service);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_state_of_health_public);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_storage_lifetime_api);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_strict_mode_restricted_network);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_strongbox_properties_api);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_supplemental_security_patches);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_telemetry_apis_framework_initialization);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_update_engine_api);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_use_concurrent_message_queue_in_apps);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", android_os_use_query_angle_choice);
