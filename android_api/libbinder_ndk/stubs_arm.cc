...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AIBinder_FrozenStateChangeCallback_delete);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AIBinder_FrozenStateChangeCallback_new);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AIBinder_addFrozenStateChangeCallback);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AIBinder_isSystemStable);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AIBinder_isVendorStable);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AIBinder_removeFrozenStateChangeCallback);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AIBinder_requiresVintfDeclaration);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AIBinder_setExtension);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AIBinder_setInheritRt);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AIBinder_setMinRpcThreads);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AParcel_getDataCapacity);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AParcel_setDataCapacity);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(APersistableBundle_getByteVector);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(APersistableBundle_getByteVectorKeys);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(APersistableBundle_putByteVector);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AServiceManager_checkServiceAccess);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AServiceManager_registerLazyServiceWithFlags);
...
static void __attribute__((constructor(0))) init_stub_library() {
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libbinder_ndk.so", AIBinder_FrozenStateChangeCallback_delete);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libbinder_ndk.so", AIBinder_FrozenStateChangeCallback_new);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libbinder_ndk.so", AIBinder_addFrozenStateChangeCallback);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libbinder_ndk.so", AIBinder_isSystemStable);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libbinder_ndk.so", AIBinder_isVendorStable);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libbinder_ndk.so", AIBinder_removeFrozenStateChangeCallback);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libbinder_ndk.so", AIBinder_requiresVintfDeclaration);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libbinder_ndk.so", AIBinder_setMinRpcThreads);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libbinder_ndk.so", AParcel_getDataCapacity);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libbinder_ndk.so", AParcel_setDataCapacity);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libbinder_ndk.so", APersistableBundle_getByteVector);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libbinder_ndk.so", APersistableBundle_getByteVectorKeys);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libbinder_ndk.so", APersistableBundle_putByteVector);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libbinder_ndk.so", AServiceManager_checkServiceAccess);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libbinder_ndk.so", AServiceManager_registerLazyServiceWithFlags);
