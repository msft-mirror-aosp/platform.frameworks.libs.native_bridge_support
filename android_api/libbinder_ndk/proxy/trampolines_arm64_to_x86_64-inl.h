...
{"ABinderProcess_disableBackgroundScheduling", GetTrampolineFunc<auto(uint8_t) -> void>(), reinterpret_cast<void*>(NULL)},
...
{"ABinderRpc_Accessor_asBinder", GetTrampolineFunc<auto(void*) -> void*>(), reinterpret_cast<void*>(NULL)},
{"ABinderRpc_Accessor_delegateAccessor", GetTrampolineFunc<auto(void*, void*, void*) -> int32_t>(), reinterpret_cast<void*>(NULL)},
{"ABinderRpc_Accessor_delete", GetTrampolineFunc<auto(void*) -> void>(), reinterpret_cast<void*>(NULL)},
{"ABinderRpc_Accessor_fromBinder", GetTrampolineFunc<auto(void*, void*) -> void*>(), reinterpret_cast<void*>(NULL)},
{"ABinderRpc_Accessor_new", GetTrampolineFunc<auto(void*, auto(*)(void*, void*) -> void*, void*, auto(*)(void*) -> void) -> void*>(), reinterpret_cast<void*>(NULL)},
{"ABinderRpc_ConnectionInfo_delete", GetTrampolineFunc<auto(void*) -> void>(), reinterpret_cast<void*>(NULL)},
{"ABinderRpc_ConnectionInfo_new", GetTrampolineFunc<auto(void*, uint32_t) -> void*>(), reinterpret_cast<void*>(NULL)},
{"ABinderRpc_registerAccessorProvider", GetTrampolineFunc<auto(auto(*)(void*, void*) -> void*, void*, uint64_t, void*, auto(*)(void*) -> void) -> void*>(), reinterpret_cast<void*>(NULL)},
{"ABinderRpc_unregisterAccessorProvider", GetTrampolineFunc<auto(void*) -> void>(), reinterpret_cast<void*>(NULL)},
...
{"AIBinder_Class_getFunctionName", GetTrampolineFunc<auto(void*, uint32_t) -> void*>(), reinterpret_cast<void*>(NULL)},
...
{"AIBinder_Class_setTransactionCodeToFunctionNameMap", GetTrampolineFunc<auto(void*, void*, uint64_t) -> void>(), reinterpret_cast<void*>(NULL)},
...
{"AIBinder_FrozenStateChangeCallback_delete", GetTrampolineFunc<auto(void*) -> void>(), reinterpret_cast<void*>(NULL)},
{"AIBinder_FrozenStateChangeCallback_new", GetTrampolineFunc<auto(auto(*)(void*, uint8_t) -> void, auto(*)(void*) -> void) -> void*>(), reinterpret_cast<void*>(NULL)},
...
{"AIBinder_addFrozenStateChangeCallback", GetTrampolineFunc<auto(void*, void*, void*) -> int32_t>(), reinterpret_cast<void*>(NULL)},
...
{"AIBinder_isSystemStable", GetTrampolineFunc<auto(void*) -> uint8_t>(), reinterpret_cast<void*>(NULL)},
{"AIBinder_isVendorStable", GetTrampolineFunc<auto(void*) -> uint8_t>(), reinterpret_cast<void*>(NULL)},
...
{"AIBinder_removeFrozenStateChangeCallback", GetTrampolineFunc<auto(void*, void*, void*) -> int32_t>(), reinterpret_cast<void*>(NULL)},
{"AIBinder_requiresVintfDeclaration", GetTrampolineFunc<auto(void*) -> uint8_t>(), reinterpret_cast<void*>(NULL)},
...
{"AIBinder_setMinRpcThreads", GetTrampolineFunc<auto(void*, uint16_t) -> int32_t>(), reinterpret_cast<void*>(NULL)},
...
{"AParcel_getDataCapacity", GetTrampolineFunc<auto(void*) -> uint64_t>(), reinterpret_cast<void*>(NULL)},
...
{"AParcel_setDataCapacity", GetTrampolineFunc<auto(void*, uint64_t) -> int32_t>(), reinterpret_cast<void*>(NULL)},
...
{"APersistableBundle_getByteVector", GetTrampolineFunc<auto(void*, void*, void*, int32_t) -> int32_t>(), reinterpret_cast<void*>(NULL)},
{"APersistableBundle_getByteVectorKeys", GetTrampolineFunc<auto(void*, void*, int32_t, auto(*)(int32_t, void*) -> void*, void*) -> int32_t>(), reinterpret_cast<void*>(NULL)},
...
{"APersistableBundle_putByteVector", GetTrampolineFunc<auto(void*, void*, void*, int32_t) -> void>(), reinterpret_cast<void*>(NULL)},
...
{"AServiceManager_checkServiceAccess", GetTrampolineFunc<auto(void*, int32_t, uint32_t, void*, uint32_t) -> uint8_t>(), reinterpret_cast<void*>(NULL)},
...
{"AServiceManager_registerLazyServiceWithFlags", GetTrampolineFunc<auto(void*, void*, uint32_t) -> int32_t>(), reinterpret_cast<void*>(NULL)},
