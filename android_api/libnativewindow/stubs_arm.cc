...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ANativeWindow_isProducerThrottlingEnabled);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ANativeWindow_setProducerThrottlingEnabled);
...
static void __attribute__((constructor(0))) init_stub_library() {
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libnativewindow.so", ANativeWindow_isProducerThrottlingEnabled);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libnativewindow.so", ANativeWindow_setProducerThrottlingEnabled);
