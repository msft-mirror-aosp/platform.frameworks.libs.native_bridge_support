...
{"android_crash_detail_register", GetTrampolineFunc<auto(void*, uint32_t, void*, uint32_t) -> void*>(), reinterpret_cast<void*>(NULL)},
{"android_crash_detail_replace_data", GetTrampolineFunc<auto(void*, void*, uint32_t) -> void>(), reinterpret_cast<void*>(NULL)},
{"android_crash_detail_replace_name", GetTrampolineFunc<auto(void*, void*, uint32_t) -> void>(), reinterpret_cast<void*>(NULL)},
...
{"android_mallopt", GetTrampolineFunc<auto(int32_t, void*, uint32_t) -> uint8_t>(), reinterpret_cast<void*>(NULL)},
...
{"getnameinfo", GetTrampolineFunc<auto(void*, int32_t, void*, uint32_t, void*, uint32_t, int32_t) -> int32_t>(), reinterpret_cast<void*>(NULL)},
...
{"native_bridge_aligned_alloc", GetTrampolineFunc<auto(uint32_t, uint32_t) -> void*>(), reinterpret_cast<void*>(aligned_alloc)},
{"native_bridge_calloc", GetTrampolineFunc<auto(uint32_t, uint32_t) -> void*>(), reinterpret_cast<void*>(calloc)},
...
{"native_bridge_malloc", GetTrampolineFunc<auto(uint32_t) -> void*>(), reinterpret_cast<void*>(malloc)},
...
{"native_bridge_malloc_usable_size", GetTrampolineFunc<auto(void*) -> uint32_t>(), reinterpret_cast<void*>(malloc_usable_size)},
{"native_bridge_mallopt", GetTrampolineFunc<auto(int32_t, int32_t) -> int32_t>(), reinterpret_cast<void*>(mallopt)},
{"native_bridge_memalign", GetTrampolineFunc<auto(uint32_t, uint32_t) -> void*>(), reinterpret_cast<void*>(memalign)},
...
{"pthread_attr_setguardsize", GetTrampolineFunc<auto(void*, uint32_t) -> int32_t>(), reinterpret_cast<void*>(NULL)},
...
{"pthread_attr_setstack", GetTrampolineFunc<auto(void*, void*, uint32_t) -> int32_t>(), reinterpret_cast<void*>(NULL)},
{"pthread_attr_setstacksize", GetTrampolineFunc<auto(void*, uint32_t) -> int32_t>(), reinterpret_cast<void*>(NULL)},
{"pthread_create", DoCustomTrampoline_pthread_create, reinterpret_cast<void*>(DoBadThunk)},
{"pthread_detach", GetTrampolineFunc<auto(int32_t) -> int32_t>(), reinterpret_cast<void*>(NULL)},
...
{"pthread_getcpuclockid", GetTrampolineFunc<auto(int32_t, void*) -> int32_t>(), reinterpret_cast<void*>(NULL)},
{"pthread_getname_np", GetTrampolineFunc<auto(int32_t, void*, uint32_t) -> int32_t>(), reinterpret_cast<void*>(NULL)},
{"pthread_getschedparam", GetTrampolineFunc<auto(int32_t, void*, void*) -> int32_t>(), reinterpret_cast<void*>(NULL)},
{"pthread_getspecific", GetTrampolineFunc<auto(int32_t) -> void*>(), reinterpret_cast<void*>(NULL)},
{"pthread_gettid_np", GetTrampolineFunc<auto(int32_t) -> int32_t>(), reinterpret_cast<void*>(NULL)},
...
{"pthread_kill", GetTrampolineFunc<auto(int32_t, int32_t) -> int32_t>(), reinterpret_cast<void*>(NULL)},
{"pthread_setname_np", GetTrampolineFunc<auto(int32_t, void*) -> int32_t>(), reinterpret_cast<void*>(NULL)},
{"pthread_setschedparam", GetTrampolineFunc<auto(int32_t, int32_t, void*) -> int32_t>(), reinterpret_cast<void*>(NULL)},
