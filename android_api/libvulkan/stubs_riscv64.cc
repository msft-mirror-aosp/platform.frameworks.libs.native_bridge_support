...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(vkCmdBindDescriptorSets2);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(vkCmdBindIndexBuffer);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(vkCmdBindIndexBuffer2);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(vkCmdPushConstants2);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(vkCmdPushDescriptorSet);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(vkCmdPushDescriptorSet2);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(vkCmdPushDescriptorSetWithTemplate);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(vkCmdPushDescriptorSetWithTemplate2);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(vkCmdSetLineStipple);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(vkCmdSetRenderingAttachmentLocations);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(vkCmdSetRenderingInputAttachmentIndices);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(vkCopyImageToImage);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(vkCopyImageToMemory);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(vkCopyMemoryToImage);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(vkGetDeviceImageSubresourceLayout);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(vkGetImageSubresourceLayout2);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(vkGetRenderingAreaGranularity);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(vkMapMemory2);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(vkTransitionImageLayout);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(vkTrimCommandPool);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(vkUnmapMemory);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(vkUnmapMemory2);
...
static void __attribute__((constructor(0))) init_stub_library() {
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libvulkan.so", vkCmdBindDescriptorSets2);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libvulkan.so", vkCmdBindIndexBuffer);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libvulkan.so", vkCmdBindIndexBuffer2);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libvulkan.so", vkCmdPushConstants2);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libvulkan.so", vkCmdPushDescriptorSet);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libvulkan.so", vkCmdPushDescriptorSet2);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libvulkan.so", vkCmdPushDescriptorSetWithTemplate);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libvulkan.so", vkCmdPushDescriptorSetWithTemplate2);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libvulkan.so", vkCmdSetLineStipple);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libvulkan.so", vkCmdSetRenderingAttachmentLocations);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libvulkan.so", vkCmdSetRenderingInputAttachmentIndices);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libvulkan.so", vkCopyImageToImage);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libvulkan.so", vkCopyImageToMemory);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libvulkan.so", vkCopyMemoryToImage);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libvulkan.so", vkGetDeviceImageSubresourceLayout);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libvulkan.so", vkGetImageSubresourceLayout2);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libvulkan.so", vkGetRenderingAreaGranularity);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libvulkan.so", vkMapMemory2);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libvulkan.so", vkTransitionImageLayout);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libvulkan.so", vkUnmapMemory2);
