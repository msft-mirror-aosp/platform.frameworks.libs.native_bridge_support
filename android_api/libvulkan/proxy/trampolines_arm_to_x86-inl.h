...
{"vkCmdBindIndexBuffer2", GetTrampolineFunc<auto(void*, uint64_t, uint64_t, uint64_t, uint32_t) -> void>(), reinterpret_cast<void*>(NULL)},
...
{"vkCmdPushDescriptorSetWithTemplate", GetTrampolineFunc<auto(void*, uint64_t, uint64_t, uint32_t, void*) -> void>(), reinterpret_cast<void*>(NULL)},
...
{"_ZTVN3com7android8graphics9libvulkan5flags13flag_providerE", 4},
};  // kKnownVariables
// clang-format on
