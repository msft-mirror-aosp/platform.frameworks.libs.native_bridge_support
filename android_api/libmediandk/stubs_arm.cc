...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecAudioCapabilities_getBitrateRange);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecAudioCapabilities_getInputChannelCountRanges);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecAudioCapabilities_getMaxInputChannelCount);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecAudioCapabilities_getMinInputChannelCount);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecAudioCapabilities_getSupportedSampleRateRanges);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecAudioCapabilities_getSupportedSampleRates);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecAudioCapabilities_isSampleRateSupported);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecEncoderCapabilities_getComplexityRange);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecEncoderCapabilities_getQualityRange);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecEncoderCapabilities_getSupportedLayeringSchemas);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecEncoderCapabilities_isBitrateModeSupported);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecPerformancePoint_covers);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecPerformancePoint_coversFormat);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecPerformancePoint_create);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecPerformancePoint_destroy);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecPerformancePoint_equals);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecVideoCapabilities_areSizeAndRateSupported);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecVideoCapabilities_getAchievableFrameRatesFor);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecVideoCapabilities_getBitrateRange);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecVideoCapabilities_getHeightAlignment);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecVideoCapabilities_getNextSupportedPerformancePoint);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecVideoCapabilities_getSupportedFrameRates);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecVideoCapabilities_getSupportedFrameRatesFor);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecVideoCapabilities_getSupportedHeights);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecVideoCapabilities_getSupportedHeightsFor);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecVideoCapabilities_getSupportedWidths);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecVideoCapabilities_getSupportedWidthsFor);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecVideoCapabilities_getWidthAlignment);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACodecVideoCapabilities_isSizeSupported);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AImageReader_setDefaultAHardwareBufferFormat);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AImageReader_setDefaultBufferDataSpace);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AImageReader_setDefaultBufferSize);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AImageReader_setImageListener);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AImageReader_setMaxImages);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AImageReader_setUsage);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AImage_getTransform);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AMediaCodecInfo_getAudioCapabilities);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AMediaCodecInfo_getCanonicalName);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AMediaCodecInfo_getEncoderCapabilities);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AMediaCodecInfo_getKind);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AMediaCodecInfo_getMaxSupportedInstances);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AMediaCodecInfo_getMediaCodecInfoType);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AMediaCodecInfo_getMediaType);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AMediaCodecInfo_getVideoCapabilities);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AMediaCodecInfo_isFeatureRequired);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AMediaCodecInfo_isFeatureSupported);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AMediaCodecInfo_isFormatSupported);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AMediaCodecInfo_isVendor);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AMediaCodecStore_findNextDecoderForFormat);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AMediaCodecStore_findNextEncoderForFormat);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AMediaCodecStore_getCodecInfo);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AMediaCodecStore_getSupportedMediaTypes);
...
DEFINE_INTERCEPTABLE_STUB_VARIABLE(AMEDIAFORMAT_KEY_CSD_VVC);
...
DEFINE_INTERCEPTABLE_STUB_VARIABLE(AMEDIAFORMAT_KEY_HDR_ST2094_50_INFO);
...
DEFINE_INTERCEPTABLE_STUB_VARIABLE(AMEDIAFORMAT_KEY_HORIZONTAL_FLIP);
...
DEFINE_INTERCEPTABLE_STUB_VARIABLE(AMediaCodecInfo_FEATURE_AdaptivePlayback);
DEFINE_INTERCEPTABLE_STUB_VARIABLE(AMediaCodecInfo_FEATURE_DetachedSurface);
DEFINE_INTERCEPTABLE_STUB_VARIABLE(AMediaCodecInfo_FEATURE_DynamicColorAspects);
DEFINE_INTERCEPTABLE_STUB_VARIABLE(AMediaCodecInfo_FEATURE_DynamicTimestamp);
DEFINE_INTERCEPTABLE_STUB_VARIABLE(AMediaCodecInfo_FEATURE_EncodingStatistics);
DEFINE_INTERCEPTABLE_STUB_VARIABLE(AMediaCodecInfo_FEATURE_FrameParsing);
DEFINE_INTERCEPTABLE_STUB_VARIABLE(AMediaCodecInfo_FEATURE_HdrEditing);
DEFINE_INTERCEPTABLE_STUB_VARIABLE(AMediaCodecInfo_FEATURE_HlgEditing);
DEFINE_INTERCEPTABLE_STUB_VARIABLE(AMediaCodecInfo_FEATURE_IntraRefresh);
DEFINE_INTERCEPTABLE_STUB_VARIABLE(AMediaCodecInfo_FEATURE_LowLatency);
DEFINE_INTERCEPTABLE_STUB_VARIABLE(AMediaCodecInfo_FEATURE_MultipleFrames);
DEFINE_INTERCEPTABLE_STUB_VARIABLE(AMediaCodecInfo_FEATURE_PartialFrame);
DEFINE_INTERCEPTABLE_STUB_VARIABLE(AMediaCodecInfo_FEATURE_QpBounds);
DEFINE_INTERCEPTABLE_STUB_VARIABLE(AMediaCodecInfo_FEATURE_Roi);
DEFINE_INTERCEPTABLE_STUB_VARIABLE(AMediaCodecInfo_FEATURE_SecurePlayback);
DEFINE_INTERCEPTABLE_STUB_VARIABLE(AMediaCodecInfo_FEATURE_TunneledPlayback);

static void __attribute__((constructor(0))) init_stub_library() {
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecAudioCapabilities_getBitrateRange);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecAudioCapabilities_getInputChannelCountRanges);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecAudioCapabilities_getMaxInputChannelCount);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecAudioCapabilities_getMinInputChannelCount);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecAudioCapabilities_getSupportedSampleRateRanges);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecAudioCapabilities_getSupportedSampleRates);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecAudioCapabilities_isSampleRateSupported);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecEncoderCapabilities_getComplexityRange);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecEncoderCapabilities_getQualityRange);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecEncoderCapabilities_getSupportedLayeringSchemas);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecEncoderCapabilities_isBitrateModeSupported);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecPerformancePoint_covers);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecPerformancePoint_coversFormat);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecPerformancePoint_create);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecPerformancePoint_destroy);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecPerformancePoint_equals);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecVideoCapabilities_areSizeAndRateSupported);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecVideoCapabilities_getAchievableFrameRatesFor);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecVideoCapabilities_getBitrateRange);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecVideoCapabilities_getHeightAlignment);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecVideoCapabilities_getNextSupportedPerformancePoint);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecVideoCapabilities_getSupportedFrameRates);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecVideoCapabilities_getSupportedFrameRatesFor);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecVideoCapabilities_getSupportedHeights);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecVideoCapabilities_getSupportedHeightsFor);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecVideoCapabilities_getSupportedWidths);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecVideoCapabilities_getSupportedWidthsFor);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecVideoCapabilities_getWidthAlignment);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", ACodecVideoCapabilities_isSizeSupported);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", AImageReader_setDefaultAHardwareBufferFormat);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", AImageReader_setDefaultBufferDataSpace);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", AImageReader_setDefaultBufferSize);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", AImageReader_setImageListener);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", AImageReader_setMaxImages);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", AImageReader_setUsage);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", AImage_getTransform);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", AMediaCodecInfo_getAudioCapabilities);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", AMediaCodecInfo_getCanonicalName);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", AMediaCodecInfo_getEncoderCapabilities);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", AMediaCodecInfo_getKind);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", AMediaCodecInfo_getMaxSupportedInstances);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", AMediaCodecInfo_getMediaCodecInfoType);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", AMediaCodecInfo_getMediaType);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", AMediaCodecInfo_getVideoCapabilities);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", AMediaCodecInfo_isFeatureRequired);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", AMediaCodecInfo_isFeatureSupported);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", AMediaCodecInfo_isFormatSupported);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", AMediaCodecInfo_isVendor);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", AMediaCodecStore_findNextDecoderForFormat);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", AMediaCodecStore_findNextEncoderForFormat);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", AMediaCodecStore_getCodecInfo);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libmediandk.so", AMediaCodecStore_getSupportedMediaTypes);
  ...
  INIT_INTERCEPTABLE_STUB_VARIABLE("libmediandk.so", AMEDIAFORMAT_KEY_CSD_VVC);
  ...
  INIT_INTERCEPTABLE_STUB_VARIABLE("libmediandk.so", AMEDIAFORMAT_KEY_HDR_ST2094_50_INFO);
  ...
  INIT_INTERCEPTABLE_STUB_VARIABLE("libmediandk.so", AMEDIAFORMAT_KEY_HORIZONTAL_FLIP);
  ...
  INIT_INTERCEPTABLE_STUB_VARIABLE("libmediandk.so", AMediaCodecInfo_FEATURE_AdaptivePlayback);
  INIT_INTERCEPTABLE_STUB_VARIABLE("libmediandk.so", AMediaCodecInfo_FEATURE_DetachedSurface);
  INIT_INTERCEPTABLE_STUB_VARIABLE("libmediandk.so", AMediaCodecInfo_FEATURE_DynamicColorAspects);
  INIT_INTERCEPTABLE_STUB_VARIABLE("libmediandk.so", AMediaCodecInfo_FEATURE_DynamicTimestamp);
  INIT_INTERCEPTABLE_STUB_VARIABLE("libmediandk.so", AMediaCodecInfo_FEATURE_EncodingStatistics);
  INIT_INTERCEPTABLE_STUB_VARIABLE("libmediandk.so", AMediaCodecInfo_FEATURE_FrameParsing);
  INIT_INTERCEPTABLE_STUB_VARIABLE("libmediandk.so", AMediaCodecInfo_FEATURE_HdrEditing);
  INIT_INTERCEPTABLE_STUB_VARIABLE("libmediandk.so", AMediaCodecInfo_FEATURE_HlgEditing);
  INIT_INTERCEPTABLE_STUB_VARIABLE("libmediandk.so", AMediaCodecInfo_FEATURE_IntraRefresh);
  INIT_INTERCEPTABLE_STUB_VARIABLE("libmediandk.so", AMediaCodecInfo_FEATURE_LowLatency);
  INIT_INTERCEPTABLE_STUB_VARIABLE("libmediandk.so", AMediaCodecInfo_FEATURE_MultipleFrames);
  INIT_INTERCEPTABLE_STUB_VARIABLE("libmediandk.so", AMediaCodecInfo_FEATURE_PartialFrame);
  INIT_INTERCEPTABLE_STUB_VARIABLE("libmediandk.so", AMediaCodecInfo_FEATURE_QpBounds);
  INIT_INTERCEPTABLE_STUB_VARIABLE("libmediandk.so", AMediaCodecInfo_FEATURE_Roi);
  INIT_INTERCEPTABLE_STUB_VARIABLE("libmediandk.so", AMediaCodecInfo_FEATURE_SecurePlayback);
  INIT_INTERCEPTABLE_STUB_VARIABLE("libmediandk.so", AMediaCodecInfo_FEATURE_TunneledPlayback);
}
// clang-format on
