...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ASessionCreationConfig_setAudioPerformance);
...
static void __attribute__((constructor(0))) init_stub_library() {
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ASessionCreationConfig_setAudioPerformance);
