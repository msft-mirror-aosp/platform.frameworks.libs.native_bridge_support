...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AActivityManager_ProcessObserver_setOnForegroundActivitiesChanged);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AActivityManager_ProcessObserver_setOnForegroundServicesChanged);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AActivityManager_ProcessObserver_setOnProcessDied);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AActivityManager_ProcessObserver_setOnProcessStarted);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AActivityManager_RunningAppProcessInfoList_destroy);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AActivityManager_RunningAppProcessInfoList_get);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AActivityManager_RunningAppProcessInfoList_getSize);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AActivityManager_addUidImportanceListener);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AActivityManager_createProcessObserver);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AActivityManager_destroyProcessObserver);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AActivityManager_getRunningAppProcesses);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AActivityManager_registerProcessObserver);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AActivityManager_removeUidImportanceListener);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AActivityManager_unregisterProcessObserver);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACpuHeadroomParams_create);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACpuHeadroomParams_destroy);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACpuHeadroomParams_getCalculationType);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACpuHeadroomParams_getCalculationWindowMillis);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACpuHeadroomParams_setCalculationType);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACpuHeadroomParams_setCalculationWindowMillis);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ACpuHeadroomParams_setTids);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ADisplayLutsEntry_createEntry);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ADisplayLutsEntry_destroy);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ADisplayLutsEntry_getBuffer);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ADisplayLutsEntry_getDimension);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ADisplayLutsEntry_getSamplingKey);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ADisplayLutsEntry_getSize);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ADisplayLuts_create);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ADisplayLuts_destroy);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ADisplayLuts_setEntries);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ADynamicInstrumentationManager_ExecutableMethodFileOffsets_destroy);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ADynamicInstrumentationManager_ExecutableMethodFileOffsets_getContainerOffset);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ADynamicInstrumentationManager_ExecutableMethodFileOffsets_getContainerPath);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ADynamicInstrumentationManager_ExecutableMethodFileOffsets_getMethodOffset);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ADynamicInstrumentationManager_MethodDescriptor_create);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ADynamicInstrumentationManager_MethodDescriptor_destroy);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ADynamicInstrumentationManager_TargetProcess_create);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ADynamicInstrumentationManager_TargetProcess_destroy);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ADynamicInstrumentationManager_getExecutableMethodFileOffsets);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AGpuHeadroomParams_create);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AGpuHeadroomParams_destroy);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AGpuHeadroomParams_getCalculationType);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AGpuHeadroomParams_getCalculationWindowMillis);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AGpuHeadroomParams_setCalculationType);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AGpuHeadroomParams_setCalculationWindowMillis);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ANativeService_setOnBindCallback);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ANativeService_setOnDestroyCallback);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ANativeService_setOnRebindCallback);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ANativeService_setOnTrimMemoryCallback);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ANativeService_setOnUnbindCallback);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ANpuBuffer_unmap);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ANpuManager_AllocRequest_create);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ANpuManager_AllocRequest_free);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ANpuManager_AllocRequest_setBufferPriority);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ANpuManager_AllocRequest_setBufferType);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ANpuManager_AllocRequest_setCookie);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ANpuManager_AllocRequest_setDeviceNumber);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ANpuManager_AllocRequest_setFileSegmentToLoad);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ANpuManager_AllocRequest_setOnAlloc);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ANpuManager_AllocRequest_setOnPreempt);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ANpuManager_AllocRequest_setProtectionFlags);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ANpuManager_AllocRequest_setSize);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ANpuManager_allocAsync);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ANpuManager_isSupported);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(APerformanceHint_borrowSessionFromJava);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(APerformanceHint_closeSession);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(APerformanceHint_closeSessionFromJava);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(APerformanceHint_createSession);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(APerformanceHint_createSessionFromJava);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(APerformanceHint_createSessionInternal);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(APerformanceHint_createSessionUsingConfig);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(APerformanceHint_createSessionUsingConfigInternal);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(APerformanceHint_getManager);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(APerformanceHint_getMaxGraphicsPipelineThreadsCount);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(APerformanceHint_getPreferredUpdateRateNanos);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(APerformanceHint_getRateLimiterPropertiesForTesting);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(APerformanceHint_getThreadIds);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(APerformanceHint_isFeatureSupported);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(APerformanceHint_notifyWorkloadIncrease);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(APerformanceHint_notifyWorkloadReset);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(APerformanceHint_notifyWorkloadSpike);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(APerformanceHint_setNativeSurfaces);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(APerformanceHint_setPreferPowerEfficiency);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(APerformanceHint_setReportBatchSizeCapForTesting);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(APerformanceHint_setThreads);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(APerformanceHint_setUseFMQForTesting);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ARunningAppProcessInfo_getImportance);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ARunningAppProcessInfo_getPackageList);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ARunningAppProcessInfo_getPid);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ARunningAppProcessInfo_getProcessName);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ARunningAppProcessInfo_getUid);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ASessionCreationConfig_create);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ASessionCreationConfig_release);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ASessionCreationConfig_setGraphicsPipeline);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ASessionCreationConfig_setNativeSurfaces);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ASessionCreationConfig_setPreferPowerEfficiency);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ASessionCreationConfig_setTargetWorkDurationNanos);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ASessionCreationConfig_setTids);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ASessionCreationConfig_setUseAutoTiming);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ASurfaceTransaction_setBufferWithRelease);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ASurfaceTransaction_setLuts);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ASystemHealth_getCpuHeadroom);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ASystemHealth_getCpuHeadroomCalculationWindowRange);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ASystemHealth_getCpuHeadroomMinIntervalMillis);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ASystemHealth_getGpuHeadroom);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ASystemHealth_getGpuHeadroomCalculationWindowRange);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ASystemHealth_getGpuHeadroomMinIntervalMillis);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ASystemHealth_getMaxCpuHeadroomTidsSize);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(ASystemHealth_setIHintManagerForTesting);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AThermal_registerThermalHeadroomListener);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AThermal_unregisterThermalHeadroomListener);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(android_getnetworkblockedreason);
...
static void __attribute__((constructor(0))) init_stub_library() {
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", AActivityManager_ProcessObserver_setOnForegroundActivitiesChanged);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", AActivityManager_ProcessObserver_setOnForegroundServicesChanged);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", AActivityManager_ProcessObserver_setOnProcessDied);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", AActivityManager_ProcessObserver_setOnProcessStarted);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", AActivityManager_RunningAppProcessInfoList_destroy);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", AActivityManager_RunningAppProcessInfoList_get);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", AActivityManager_RunningAppProcessInfoList_getSize);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", AActivityManager_addUidImportanceListener);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", AActivityManager_createProcessObserver);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", AActivityManager_destroyProcessObserver);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", AActivityManager_getRunningAppProcesses);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", AActivityManager_registerProcessObserver);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", AActivityManager_removeUidImportanceListener);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", AActivityManager_unregisterProcessObserver);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ACpuHeadroomParams_create);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ACpuHeadroomParams_destroy);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ACpuHeadroomParams_getCalculationType);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ACpuHeadroomParams_getCalculationWindowMillis);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ACpuHeadroomParams_setCalculationType);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ACpuHeadroomParams_setCalculationWindowMillis);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ACpuHeadroomParams_setTids);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ADisplayLutsEntry_createEntry);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ADisplayLutsEntry_destroy);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ADisplayLutsEntry_getBuffer);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ADisplayLutsEntry_getDimension);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ADisplayLutsEntry_getSamplingKey);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ADisplayLutsEntry_getSize);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ADisplayLuts_create);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ADisplayLuts_destroy);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ADisplayLuts_setEntries);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ADynamicInstrumentationManager_ExecutableMethodFileOffsets_destroy);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ADynamicInstrumentationManager_ExecutableMethodFileOffsets_getContainerOffset);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ADynamicInstrumentationManager_ExecutableMethodFileOffsets_getContainerPath);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ADynamicInstrumentationManager_ExecutableMethodFileOffsets_getMethodOffset);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ADynamicInstrumentationManager_MethodDescriptor_create);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ADynamicInstrumentationManager_MethodDescriptor_destroy);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ADynamicInstrumentationManager_TargetProcess_create);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ADynamicInstrumentationManager_TargetProcess_destroy);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ADynamicInstrumentationManager_getExecutableMethodFileOffsets);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", AGpuHeadroomParams_create);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", AGpuHeadroomParams_destroy);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", AGpuHeadroomParams_getCalculationType);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", AGpuHeadroomParams_getCalculationWindowMillis);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", AGpuHeadroomParams_setCalculationType);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", AGpuHeadroomParams_setCalculationWindowMillis);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ANativeService_setOnBindCallback);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ANativeService_setOnDestroyCallback);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ANativeService_setOnRebindCallback);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ANativeService_setOnTrimMemoryCallback);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ANativeService_setOnUnbindCallback);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ANpuBuffer_unmap);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ANpuManager_AllocRequest_create);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ANpuManager_AllocRequest_free);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ANpuManager_AllocRequest_setBufferPriority);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ANpuManager_AllocRequest_setBufferType);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ANpuManager_AllocRequest_setCookie);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ANpuManager_AllocRequest_setDeviceNumber);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ANpuManager_AllocRequest_setFileSegmentToLoad);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ANpuManager_AllocRequest_setOnAlloc);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ANpuManager_AllocRequest_setOnPreempt);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ANpuManager_AllocRequest_setProtectionFlags);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ANpuManager_AllocRequest_setSize);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ANpuManager_allocAsync);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ANpuManager_isSupported);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", APerformanceHint_borrowSessionFromJava);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", APerformanceHint_closeSession);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", APerformanceHint_closeSessionFromJava);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", APerformanceHint_createSession);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", APerformanceHint_createSessionFromJava);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", APerformanceHint_createSessionInternal);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", APerformanceHint_createSessionUsingConfig);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", APerformanceHint_createSessionUsingConfigInternal);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", APerformanceHint_getManager);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", APerformanceHint_getMaxGraphicsPipelineThreadsCount);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", APerformanceHint_getPreferredUpdateRateNanos);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", APerformanceHint_getRateLimiterPropertiesForTesting);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", APerformanceHint_getThreadIds);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", APerformanceHint_isFeatureSupported);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", APerformanceHint_notifyWorkloadIncrease);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", APerformanceHint_notifyWorkloadReset);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", APerformanceHint_notifyWorkloadSpike);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", APerformanceHint_setNativeSurfaces);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", APerformanceHint_setPreferPowerEfficiency);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", APerformanceHint_setReportBatchSizeCapForTesting);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", APerformanceHint_setThreads);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", APerformanceHint_setUseFMQForTesting);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ARunningAppProcessInfo_getImportance);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ARunningAppProcessInfo_getPackageList);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ARunningAppProcessInfo_getPid);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ARunningAppProcessInfo_getProcessName);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ARunningAppProcessInfo_getUid);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ASessionCreationConfig_create);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ASessionCreationConfig_release);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ASessionCreationConfig_setGraphicsPipeline);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ASessionCreationConfig_setNativeSurfaces);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ASessionCreationConfig_setPreferPowerEfficiency);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ASessionCreationConfig_setTargetWorkDurationNanos);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ASessionCreationConfig_setTids);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ASessionCreationConfig_setUseAutoTiming);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ASurfaceTransaction_setBufferWithRelease);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ASurfaceTransaction_setLuts);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ASystemHealth_getCpuHeadroom);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ASystemHealth_getCpuHeadroomCalculationWindowRange);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ASystemHealth_getCpuHeadroomMinIntervalMillis);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ASystemHealth_getGpuHeadroom);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ASystemHealth_getGpuHeadroomCalculationWindowRange);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ASystemHealth_getGpuHeadroomMinIntervalMillis);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ASystemHealth_getMaxCpuHeadroomTidsSize);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", ASystemHealth_setIHintManagerForTesting);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", AThermal_registerThermalHeadroomListener);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", AThermal_unregisterThermalHeadroomListener);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", android_getnetworkblockedreason);
