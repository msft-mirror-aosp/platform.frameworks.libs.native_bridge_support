...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(APerformanceHint_setUseNewLoadHintBehaviorForTesting);
...
static void __attribute__((constructor(0))) init_stub_library() {
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", APerformanceHint_setUseNewLoadHintBehaviorForTesting);
