...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AAudioStreamBuilder_setPartialDataCallback);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AAudioStreamBuilder_setRoutingChangedCallback);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AAudioStream_flushFromFrame);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AAudioStream_getPlaybackParameters);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AAudioStream_setPlaybackParameters);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AAudio_getFlushFromFrameSupport);
...
static void __attribute__((constructor(0))) init_stub_library() {
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libaaudio.so", AAudioStreamBuilder_setPartialDataCallback);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libaaudio.so", AAudioStreamBuilder_setRoutingChangedCallback);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libaaudio.so", AAudioStream_flushFromFrame);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libaaudio.so", AAudioStream_getPlaybackParameters);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libaaudio.so", AAudioStream_setPlaybackParameters);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libaaudio.so", AAudio_getFlushFromFrameSupport);
