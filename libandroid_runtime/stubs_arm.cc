...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(_ZN7android26NativeDisplayEventReceiver13dispatchVsyncExNS_17PhysicalDisplayIdEjNS_14VsyncEventDataE);
...
static void __attribute__((constructor(0))) init_stub_library() {
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid_runtime.so", _ZN7android26NativeDisplayEventReceiver13dispatchVsyncExNS_17PhysicalDisplayIdEjNS_14VsyncEventDataE);
