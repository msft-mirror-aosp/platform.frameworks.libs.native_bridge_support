...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AChoreographerFrameCallbackData_getFrameTimelineDeadline);
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AChoreographerFrameCallbackData_getFrameTimelineExpectedPresentTime);
...
DEFINE_INTERCEPTABLE_STUB_FUNCTION(AChoreographer_postExtendedFrameCallback);
...
static void __attribute__((constructor(0))) init_stub_library() {
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", AChoreographerFrameCallbackData_getFrameTimelineDeadline);
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", AChoreographerFrameCallbackData_getFrameTimelineExpectedPresentTime);
  ...
  INIT_INTERCEPTABLE_STUB_FUNCTION("libandroid.so", AChoreographer_postExtendedFrameCallback);
